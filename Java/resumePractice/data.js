var resumeData = {
	...
	'skills': ['Quality Assurance', 'Agile/Scrum', 'Functional Testing', 'XML/Json', 'Jira', 'Test Planning', 'Adaptive', 'Star Wars Knowledge'],
  
  'experience': [
    {
    	'title': 'QA Tester',
    	'organization': 'Quality Logic inc',
    	'years': '2015 - Present',
    	'duties': [
  ...
  'education': [
    ...
    },
    {
      ...
      'years': '2012 - 2013',
      'intrests': [
        'Learned the basics of Node.js to build a small app.', 
      ]
    },
  ]
}
